...
public class ingresos extends AppCompatActivity {
    ...
    private void llenar(){
        String url = "https://humanservices21.tk/android/get_data.php?tipo=ingreso&uaid=prueba";
    ...
    public void regresar(View v){
        Intent i = new Intent(ingresos.this, principal.class);
        startActivity(i);
    }

    public void ingreasr(View v){
        Intent i = new Intent(ingresos.this, registra_ingreso.class);
        startActivity(i);
    }
