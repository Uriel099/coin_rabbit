...
public class registra_ingreso extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_registra_ingreso);

        monto = findViewById(R.id.monto_reg);
        concepto = findViewById(R.id.conc_reg);
        observacion = findViewById(R.id.obs_reg);
    }
